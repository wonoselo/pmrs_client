<template>
  <div>
    <panel title="Summary OnTime">
      <div class="card bg-light border-0 text-white">
        <div class="card-body">
          <router-link to="/summaryval" class="btn btn-outline-info" type="button">Summary Validasi</router-link>
          <br><br>
      ...
      <div class="card">
        <div class="card-body">
          <DxChart title="Summary OnTime" ref="chart">
    ...
    handleSubmit(e) {
      ...
      this.isVisible =
        moment(startDate).format('YYYY') !== moment(endDate).format('YYYY')
          ? true
          : false;
      CrudService.findData('summaryontime', {
        startDate: startDate,
        endDate: endDate,
      }).then((response) => {
