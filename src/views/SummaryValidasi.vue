<template>
  <div>
    <panel title="Summary Validasi">
      ...
      <div class="card">
        <div class="card-body">
          <DxChart title="Summary Validasi" ref="chart">
      ...
      dataSource: {
        ...
        fields: [
          ...
          },
          {
            ...
            dataField: 'Status_VALIDASI',
            dataType: 'string',
            area: 'column',
            filterValues: ['Status_VALIDASI'&&'Ontime','Late']
          },
          {
            caption: 'WO count',
            dataField: 'WO_NUMBER',
    ...
    handleSubmit(e) {
      ...
      this.isVisible =
        moment(startDate).format('YYYY') !== moment(endDate).format('YYYY')
          ? true
          : false;
      CrudService.findData('summaryval', {
        startDate: startDate,
        endDate: endDate,
      }).then((response) => {
