<template>
    <div>
        <panel title="CPR Trend By Sector and Activity">
     ...
     <div class="card">
        ...
        >
            ...
            >
                ...
                <DxColumn data-field="COMP_ID" :calculate-cell-value="calculateCellValue" width="70"/>
                ...
                <DxColumn data-field="FEATSIZE" width="60" data-type="number" :format="{ type:'fixedPoint', precision :1 }"/>
                <DxColumn data-field="REQ_DATE" width="80" data-type="date" format="dd/MM/yyyy"/>
                <DxColumn data-field="REQ_SIZE" width="80" data-type="number" :format="{ type:'fixedPoint', precision :1 }"/>
...
import {
    DxPivotGrid,
    DxFieldChooser,
    DxFieldPanel, DxExport
} from 'devextreme-vue/pivot-grid';
import { DxDataGrid, DxColumn,DxSearchPanel, DxColumnChooser, DxColumnFixing, DxHeaderFilter,DxFilterRow } from 'devextreme-vue/data-grid';
...
export default {
    components: {
        ...
        DxButtonItem,
        DxDataGrid,
        DxColumn,  DxExport,DxSearchPanel, DxColumnChooser, DxColumnFixing, DxHeaderFilter,DxFilterRow,DxLoadPanel
    },
    data() {
        const ds ={}  
        var toDay = new Date();
    ...
    methods: {
        ...
        onCellClick(e) {
            if (e.area == 'data') {
                ...
                this.popupTitle = `Detail CPR for ${ (rowPathName ? rcolName : 'Total')+', CPR Date : '+sDate } ` ;
        ...
        handleSubmit(e) {
            ...
            CrudService.findData('cpr',{startDate:startDate, endDate : endDate}).then(response => {
